...
class Producer:
    def __init__(self, datatype):
        ...
        if datatype == "temp":
            ...
            self.queue = [middleware.PickleQueue(f"/{self.type}/temperature", middleware.MiddlewareType.PRODUCER),
                          middleware.PickleQueue(f"/{self.type}/humidity", middleware.MiddlewareType.PRODUCER), 
                          middleware.PickleQueue(f"/{self.type}/pressure", middleware.MiddlewareType.PRODUCER)]
